import { MessageSquare, Users, Sparkles, Phone, Video } from "lucide-react";
      ...
      <div className="max-w-2xl text-center space-y-6 sm:space-y-8">
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-base-content/70 leading-relaxed max-w-xl mx-auto">
            Connect with friends, share moments, and stay in touch with high-quality messaging and calls.
          </p>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mt-6 sm:mt-8">
          ...
          <div className="group p-4 sm:p-6 bg-gradient-to-br from-base-100 to-base-200 rounded-2xl border border-base-300/30 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-red-500/10 rounded-xl flex items-center justify-center mx-auto mb-3 group-hover:bg-red-500/20 transition-colors">
              <Phone className="w-5 h-5 sm:w-6 sm:h-6 text-red-500" />
            </div>
            <p className="text-xs sm:text-sm font-semibold text-base-content/80">Voice Calls</p>
          </div>
          <div className="group p-4 sm:p-6 bg-gradient-to-br from-base-100 to-base-200 rounded-2xl border border-base-300/30 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            ...
            <p className="text-xs sm:text-sm font-semibold text-base-content/80">Video Calls</p>
          </div>
          <div className="group p-4 sm:p-6 bg-gradient-to-br from-base-100 to-base-200 rounded-2xl border border-base-300/30 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
